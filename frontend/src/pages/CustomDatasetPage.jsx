...
function UploadZone({ onFiles, uploading, schema, uploadStatus, onReset, onAiGenerate, generatingSchema }) {
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row min-h-0 h-full w-full">
      ...
      {/* ── LEFT PANEL: The Hook ── */}
      <div className="flex-1 bg-surface-2 text-text p-8 md:p-16 flex flex-col justify-center relative overflow-hidden border-r border-border/50">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-blue-500/10 rounded-full blur-[120px] pointer-events-none animate-pulse dark:bg-blue-500/15 dark:mix-blend-screen" style={{ animationDuration: '5s' }} />
        <div className="absolute top-1/2 left-1/2 translate-x-1/4 -translate-y-1/4 w-[600px] h-[400px] bg-purple-500/10 rounded-full blur-[100px] pointer-events-none dark:bg-purple-500/15 dark:mix-blend-screen" />
        ...
        <div className="relative z-10 max-w-xl mx-auto w-full animate-fade-in-up">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center shrink-0 border border-primary/20 shadow-sm backdrop-blur-sm">
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl bg-success/10 flex items-center justify-center shrink-0 border border-success/20 shadow-sm backdrop-blur-sm">
