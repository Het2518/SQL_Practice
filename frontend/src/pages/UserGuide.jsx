      ...
      <div style={{ display: 'flex', flex: 1, maxWidth: 1400, margin: '0 auto', width: '100%' }}>
        ...
        >
          <section id="getting-started">
            <h2 style={{ fontSize: 28, marginBottom: 16, color: 'var(--text)', fontWeight: 800 }}>
              Getting Started
            </h2>
            ...
            >
              ...
              <p
                style={{ margin: 0, color: 'var(--text-secondary)', fontSize: 14, lineHeight: 1.6 }}
              >
          ...
          <section id="editor-features">
            ...
            <table
              style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 14 }}
            >
              <thead>
          ...
          <section id="faq">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 24, marginTop: 20 }}>
              <div style={{ paddingBottom: 20, borderBottom: '1px solid var(--border)' }}>
                <h4 style={{ margin: '0 0 8px', fontSize: 16, color: 'var(--text)' }}>
