...
export const bankingQuestions = [
  ...
  make(241, 'banking', 'easy', ['topic:Basic SQL', 'Where', 'company:JPMorgan'], 
  ...
  make(242, 'banking', 'easy', ['topic:String Functions', 'Basic SQL', 'company:GoldmanSachs'], 
  ...
  make(243, 'banking', 'easy', ['topic:Aggregate Functions', 'Math', 'company:Citi'], 
  ...
  make(244, 'banking', 'easy', ['topic:Basic SQL', 'Null Handling', 'company:MorganStanley'], 
  ...
  make(245, 'banking', 'easy', ['topic:Data Analysis', 'Group By', 'company:BankOfAmerica'], 
  ...
  make(246, 'banking', 'easy', ['topic:Date Functions', 'Where', 'company:CapitalOne'], 
  ...
  make(247, 'banking', 'easy', ['topic:Aggregate Functions', 'Distinct', 'company:HSBC'], 
  ...
  make(248, 'banking', 'easy', ['topic:Data Analysis', 'Order By', 'company:WellsFargo'], 
  ...
  make(249, 'banking', 'easy', ['topic:Basic SQL', 'In', 'company:Barclays'], 
  ...
  make(250, 'banking', 'easy', ['topic:Basic SQL', 'Limit', 'company:UBS'], 
  ...
  make(251, 'banking', 'easy', ['topic:Aggregate Functions', 'Math', 'company:JPMorgan'], 
  ...
  make(252, 'banking', 'easy', ['topic:Data Cleaning', 'Like', 'company:GoldmanSachs'], 
  ...
  make(253, 'banking', 'easy', ['topic:Basic SQL', 'Where', 'company:Citi'], 
  ...
  make(254, 'banking', 'easy', ['topic:Date Functions', 'String Functions', 'company:MorganStanley'], 
  ...
  make(255, 'banking', 'easy', ['topic:Aggregate Functions', 'Group By', 'company:BankOfAmerica'], 
  ...
  make(256, 'banking', 'easy', ['topic:Basic SQL', 'Math', 'company:CapitalOne'], 
  ...
  make(257, 'banking', 'easy', ['topic:Data Analysis', 'Group By', 'company:HSBC'], 
  ...
  make(258, 'banking', 'easy', ['topic:Basic SQL', 'Where', 'company:WellsFargo'], 
  ...
  make(259, 'banking', 'easy', ['topic:Aggregate Functions', 'Math', 'company:Barclays'], 
  ...
  make(260, 'banking', 'easy', ['topic:Basic SQL', 'Where', 'company:UBS'], 
  ...
  make(261, 'banking', 'medium', ['topic:Joins', 'Math', 'company:JPMorgan'], 
  ...
  make(262, 'banking', 'medium', ['topic:Joins', 'Data Analysis', 'company:GoldmanSachs'], 
  ...
  make(263, 'banking', 'medium', ['topic:Joins', 'Self Join', 'company:Citi'], 
  ...
  make(264, 'banking', 'medium', ['topic:Joins', 'Group By', 'company:MorganStanley'], 
  ...
  make(265, 'banking', 'medium', ['topic:Case Statements', 'Data Analysis', 'company:BankOfAmerica'], 
  ...
  make(266, 'banking', 'medium', ['topic:Joins', 'Having', 'company:CapitalOne'], 
  ...
  make(267, 'banking', 'medium', ['topic:Subqueries', 'Null Handling', 'company:HSBC'], 
  ...
  make(268, 'banking', 'medium', ['topic:Joins', 'Math', 'company:WellsFargo'], 
  ...
  make(269, 'banking', 'medium', ['topic:Date Functions', 'Aggregate Functions', 'company:Barclays'], 
  ...
  make(270, 'banking', 'medium', ['topic:Joins', 'Null Handling', 'company:UBS'], 
  ...
  make(271, 'banking', 'medium', ['topic:Math', 'Group By', 'company:JPMorgan'], 
  ...
  make(272, 'banking', 'medium', ['topic:Joins', 'Data Analysis', 'company:GoldmanSachs'], 
  ...
  make(273, 'banking', 'medium', ['topic:Subqueries', 'Math', 'company:Citi'], 
  ...
  make(274, 'banking', 'medium', ['topic:Case Statements', 'Data Analysis', 'company:MorganStanley'], 
  ...
  make(275, 'banking', 'medium', ['topic:Joins', 'Math', 'company:BankOfAmerica'], 
  ...
  make(276, 'banking', 'medium', ['topic:CTEs', 'Date Functions', 'company:CapitalOne'], 
  ...
  make(277, 'banking', 'medium', ['topic:Joins', 'Data Analysis', 'company:HSBC'], 
  ...
  make(278, 'banking', 'medium', ['topic:Set Operations', 'Data Analysis', 'company:WellsFargo'], 
  ...
  make(279, 'banking', 'medium', ['topic:Joins', 'Null Handling', 'company:Barclays'], 
  ...
  make(280, 'banking', 'medium', ['topic:Math', 'Data Analysis', 'company:UBS'], 
  ...
  make(281, 'banking', 'medium', ['topic:Date Functions', 'CTEs', 'company:JPMorgan'], 
  ...
  make(282, 'banking', 'medium', ['topic:Joins', 'Group By', 'company:GoldmanSachs'], 
  ...
  make(283, 'banking', 'medium', ['topic:String Functions', 'Basic SQL', 'company:Citi'], 
  ...
  make(284, 'banking', 'medium', ['topic:Joins', 'Math', 'company:MorganStanley'], 
  ...
  make(285, 'banking', 'medium', ['topic:Data Analysis', 'Group By', 'company:BankOfAmerica'], 
  ...
  make(286, 'banking', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:CapitalOne'], 
  ...
  make(287, 'banking', 'hard', ['topic:Window Functions', 'Rank', 'company:HSBC'], 
  ...
  make(288, 'banking', 'hard', ['topic:CTEs', 'Window Functions', 'company:WellsFargo'], 
  ...
  make(289, 'banking', 'hard', ['topic:Window Functions', 'Partition By', 'company:Barclays'], 
  ...
  make(290, 'banking', 'hard', ['topic:CTEs', 'Date Functions', 'company:UBS'], 
  ...
  make(291, 'banking', 'hard', ['topic:Window Functions', 'Math', 'company:JPMorgan'], 
  ...
  make(292, 'banking', 'hard', ['topic:CTEs', 'Null Handling', 'company:GoldmanSachs'], 
  ...
  make(293, 'banking', 'hard', ['topic:Window Functions', 'Ntile', 'company:Citi'], 
  ...
  make(294, 'banking', 'hard', ['topic:CTEs', 'Data Analysis', 'company:MorganStanley'], 
  ...
  make(295, 'banking', 'hard', ['topic:Self Join', 'CTEs', 'company:BankOfAmerica'], 
  ...
  make(296, 'banking', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:CapitalOne'], 
  ...
  make(297, 'banking', 'hard', ['topic:CTEs', 'Self Join', 'company:HSBC'], 
  ...
  make(298, 'banking', 'hard', ['topic:Window Functions', 'Rank', 'company:WellsFargo'], 
  ...
  make(299, 'banking', 'hard', ['topic:Math', 'Data Analysis', 'company:Barclays'], 
  ...
  make(300, 'banking', 'hard', ['topic:CTEs', 'Math', 'company:UBS'], 
