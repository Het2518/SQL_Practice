...
export const sportsQuestions = [
  ...
  make(481, 'sports', 'easy', ['topic:Basic SQL', 'Where', 'company:ESPN'], 
  ...
  make(482, 'sports', 'easy', ['topic:String Functions', 'Basic SQL', 'company:SkySports'], 
  ...
  make(483, 'sports', 'easy', ['topic:Math', 'Aggregate Functions', 'company:Opta'], 
  ...
  make(484, 'sports', 'easy', ['topic:Basic SQL', 'Null Handling', 'company:BBCSport'], 
  ...
  make(485, 'sports', 'easy', ['topic:Data Analysis', 'Group By', 'company:TheAthletic'], 
  ...
  make(486, 'sports', 'easy', ['topic:Basic SQL', 'Where', 'company:DAZN'], 
  ...
  make(487, 'sports', 'easy', ['topic:Aggregate Functions', 'Math', 'company:ESPN'], 
  ...
  make(488, 'sports', 'easy', ['topic:Basic SQL', 'Limit', 'company:SkySports'], 
  ...
  make(489, 'sports', 'easy', ['topic:Basic SQL', 'In', 'company:Opta'], 
  ...
  make(490, 'sports', 'easy', ['topic:String Functions', 'Basic SQL', 'company:BBCSport'], 
  ...
  make(491, 'sports', 'easy', ['topic:Data Analysis', 'Group By', 'company:TheAthletic'], 
  ...
  make(492, 'sports', 'easy', ['topic:Date Functions', 'String Functions', 'company:DAZN'], 
  ...
  make(493, 'sports', 'easy', ['topic:Basic SQL', 'Where', 'company:ESPN'], 
  ...
  make(494, 'sports', 'easy', ['topic:Aggregate Functions', 'Distinct', 'company:SkySports'], 
  ...
  make(495, 'sports', 'easy', ['topic:Basic SQL', 'Math', 'company:Opta'], 
  ...
  make(496, 'sports', 'easy', ['topic:Data Cleaning', 'Like', 'company:BBCSport'], 
  ...
  make(497, 'sports', 'easy', ['topic:Basic SQL', 'Where', 'company:TheAthletic'], 
  ...
  make(498, 'sports', 'easy', ['topic:Aggregate Functions', 'Group By', 'company:DAZN'], 
  ...
  make(499, 'sports', 'easy', ['topic:Basic SQL', 'Order By', 'company:ESPN'], 
  ...
  make(500, 'sports', 'easy', ['topic:Basic SQL', 'Math', 'company:SkySports'], 
  ...
  make(501, 'sports', 'medium', ['topic:Joins', 'Data Analysis', 'company:Opta'], 
  ...
  make(502, 'sports', 'medium', ['topic:Joins', 'Math', 'company:BBCSport'], 
  ...
  make(503, 'sports', 'medium', ['topic:Subqueries', 'Data Analysis', 'company:TheAthletic'], 
  ...
  make(504, 'sports', 'medium', ['topic:Joins', 'Group By', 'company:DAZN'], 
  ...
  make(505, 'sports', 'medium', ['topic:Case Statements', 'Math', 'company:ESPN'], 
  ...
  make(506, 'sports', 'medium', ['topic:Joins', 'Having', 'company:SkySports'], 
  ...
  make(507, 'sports', 'medium', ['topic:Subqueries', 'Null Handling', 'company:Opta'], 
  ...
  make(508, 'sports', 'medium', ['topic:Math', 'Data Analysis', 'company:BBCSport'], 
  ...
  make(509, 'sports', 'medium', ['topic:Joins', 'Null Handling', 'company:TheAthletic'], 
  ...
  make(510, 'sports', 'medium', ['topic:Joins', 'Data Analysis', 'company:DAZN'], 
  ...
  make(511, 'sports', 'medium', ['topic:Subqueries', 'Math', 'company:ESPN'], 
  ...
  make(512, 'sports', 'medium', ['topic:Joins', 'Group By', 'company:SkySports'], 
  ...
  make(513, 'sports', 'medium', ['topic:Joins', 'Date Functions', 'company:Opta'], 
  ...
  make(514, 'sports', 'medium', ['topic:Case Statements', 'Data Analysis', 'company:BBCSport'], 
  ...
  make(515, 'sports', 'medium', ['topic:CTEs', 'Data Analysis', 'company:TheAthletic'], 
  ...
  make(516, 'sports', 'medium', ['topic:Set Operations', 'Data Analysis', 'company:DAZN'], 
  ...
  make(517, 'sports', 'medium', ['topic:Joins', 'Self Join', 'company:ESPN'], 
  ...
  make(518, 'sports', 'medium', ['topic:Joins', 'Group By', 'company:SkySports'], 
  ...
  make(519, 'sports', 'medium', ['topic:Joins', 'Math', 'company:Opta'], 
  ...
  make(520, 'sports', 'medium', ['topic:Math', 'Data Analysis', 'company:BBCSport'], 
  ...
  make(521, 'sports', 'medium', ['topic:Joins', 'Null Handling', 'company:TheAthletic'], 
  ...
  make(522, 'sports', 'medium', ['topic:String Functions', 'Basic SQL', 'company:DAZN'], 
  ...
  make(523, 'sports', 'medium', ['topic:Math', 'Data Analysis', 'company:ESPN'], 
  ...
  make(524, 'sports', 'medium', ['topic:Group By', 'Having', 'company:SkySports'], 
  ...
  make(525, 'sports', 'medium', ['topic:Joins', 'Data Analysis', 'company:Opta'], 
  ...
  make(526, 'sports', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:BBCSport'], 
  ...
  make(527, 'sports', 'hard', ['topic:Window Functions', 'Rank', 'company:TheAthletic'], 
  ...
  make(528, 'sports', 'hard', ['topic:CTEs', 'Window Functions', 'company:DAZN'], 
  ...
  make(529, 'sports', 'hard', ['topic:Window Functions', 'Partition By', 'company:ESPN'], 
  ...
  make(530, 'sports', 'hard', ['topic:CTEs', 'Self Join', 'company:SkySports'], 
  ...
  make(531, 'sports', 'hard', ['topic:Window Functions', 'Math', 'company:Opta'], 
  ...
  make(532, 'sports', 'hard', ['topic:CTEs', 'Data Analysis', 'company:BBCSport'], 
  ...
  make(533, 'sports', 'hard', ['topic:Window Functions', 'Ntile', 'company:TheAthletic'], 
  ...
  make(534, 'sports', 'hard', ['topic:CTEs', 'Self Join', 'company:DAZN'], 
  ...
  make(535, 'sports', 'hard', ['topic:CTEs', 'Data Analysis', 'company:ESPN'], 
  ...
  make(536, 'sports', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:SkySports'], 
  ...
  make(537, 'sports', 'hard', ['topic:CTEs', 'Null Handling', 'company:Opta'], 
  ...
  make(538, 'sports', 'hard', ['topic:Window Functions', 'Rank', 'company:BBCSport'], 
  ...
  make(539, 'sports', 'hard', ['topic:Math', 'Data Analysis', 'company:TheAthletic'], 
  ...
  make(540, 'sports', 'hard', ['topic:CTEs', 'Data Analysis', 'company:DAZN'], 
