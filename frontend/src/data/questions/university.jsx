...
// UNIVERSITY QUESTIONS (IDs 121-180)
export const universityQuestions = [
  ...
  make(121, 'university', 'easy', ['topic:Basic SQL', 'Where', 'company:Harvard'], 
  ...
  make(122, 'university', 'easy', ['topic:String Functions', 'Basic SQL', 'company:MIT'], 
  ...
  make(123, 'university', 'easy', ['topic:Math', 'Aggregate Functions', 'company:Stanford'], 
  ...
  make(124, 'university', 'easy', ['topic:Basic SQL', 'Null Handling', 'company:Yale'], 
  ...
  make(125, 'university', 'easy', ['topic:Data Analysis', 'Group By', 'company:Princeton'], 
  ...
  make(126, 'university', 'easy', ['topic:Date Functions', 'Where', 'company:Columbia'], 
  ...
  make(127, 'university', 'easy', ['topic:Aggregate Functions', 'Math', 'company:UPenn'], 
  ...
  make(128, 'university', 'easy', ['topic:Basic SQL', 'Limit', 'company:Cornell'], 
  ...
  make(129, 'university', 'easy', ['topic:Basic SQL', 'In', 'company:Brown'], 
  ...
  make(130, 'university', 'easy', ['topic:String Functions', 'Basic SQL', 'company:Dartmouth'], 
  ...
  make(131, 'university', 'easy', ['topic:Data Analysis', 'Group By', 'company:UCBerkeley'], 
  ...
  make(132, 'university', 'easy', ['topic:Date Functions', 'String Functions', 'company:UCLA'], 
  ...
  make(133, 'university', 'easy', ['topic:Basic SQL', 'Where', 'company:UMich'], 
  ...
  make(134, 'university', 'easy', ['topic:Aggregate Functions', 'Distinct', 'company:UTAustin'], 
  ...
  make(135, 'university', 'easy', ['topic:Basic SQL', 'Math', 'company:UW'], 
  ...
  make(136, 'university', 'easy', ['topic:Data Cleaning', 'Like', 'company:GeorgiaTech'], 
  ...
  make(137, 'university', 'easy', ['topic:Basic SQL', 'Where', 'company:CMU'], 
  ...
  make(138, 'university', 'easy', ['topic:Aggregate Functions', 'Group By', 'company:Purdue'], 
  ...
  make(139, 'university', 'easy', ['topic:Basic SQL', 'Order By', 'company:UIUC'], 
  ...
  make(140, 'university', 'easy', ['topic:Basic SQL', 'Where', 'company:Caltech'], 
  ...
  make(141, 'university', 'medium', ['topic:Joins', 'Data Analysis', 'company:Harvard'], 
  ...
  make(142, 'university', 'medium', ['topic:Joins', 'Math', 'company:MIT'], 
  ...
  make(143, 'university', 'medium', ['topic:Subqueries', 'Data Analysis', 'company:Stanford'], 
  ...
  make(144, 'university', 'medium', ['topic:Joins', 'Group By', 'company:Yale'], 
  ...
  make(145, 'university', 'medium', ['topic:Case Statements', 'Math', 'company:Princeton'], 
  ...
  make(146, 'university', 'medium', ['topic:Joins', 'Having', 'company:Columbia'], 
  ...
  make(147, 'university', 'medium', ['topic:Subqueries', 'Null Handling', 'company:UPenn'], 
  ...
  make(148, 'university', 'medium', ['topic:Date Functions', 'Math', 'company:Cornell'], 
  ...
  make(149, 'university', 'medium', ['topic:Joins', 'Null Handling', 'company:Brown'], 
  ...
  make(150, 'university', 'medium', ['topic:Joins', 'Data Analysis', 'company:Dartmouth'], 
  ...
  make(151, 'university', 'medium', ['topic:Subqueries', 'Math', 'company:UCBerkeley'], 
  ...
  make(152, 'university', 'medium', ['topic:Joins', 'Group By', 'company:UCLA'], 
  ...
  make(153, 'university', 'medium', ['topic:Joins', 'Self Join', 'company:UMich'], 
  ...
  make(154, 'university', 'medium', ['topic:Case Statements', 'Data Analysis', 'company:UTAustin'], 
  ...
  make(155, 'university', 'medium', ['topic:CTEs', 'Data Analysis', 'company:UW'], 
  ...
  make(156, 'university', 'medium', ['topic:Set Operations', 'Data Analysis', 'company:GeorgiaTech'], 
  ...
  make(157, 'university', 'medium', ['topic:Joins', 'Date Functions', 'company:CMU'], 
  ...
  make(158, 'university', 'medium', ['topic:Joins', 'Group By', 'company:Purdue'], 
  ...
  make(159, 'university', 'medium', ['topic:Joins', 'Math', 'company:UIUC'], 
  ...
  make(160, 'university', 'medium', ['topic:Math', 'Data Analysis', 'company:Caltech'], 
  ...
  make(161, 'university', 'medium', ['topic:Joins', 'Null Handling', 'company:Harvard'], 
  ...
  make(162, 'university', 'medium', ['topic:String Functions', 'Basic SQL', 'company:MIT'], 
  ...
  make(163, 'university', 'medium', ['topic:Math', 'Date Functions', 'company:Stanford'], 
  ...
  make(164, 'university', 'medium', ['topic:Group By', 'Having', 'company:Yale'], 
  ...
  make(165, 'university', 'medium', ['topic:Joins', 'Data Analysis', 'company:Princeton'], 
  ...
  make(166, 'university', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:Columbia'], 
  ...
  make(167, 'university', 'hard', ['topic:Window Functions', 'Rank', 'company:UPenn'], 
  ...
  make(168, 'university', 'hard', ['topic:CTEs', 'Window Functions', 'company:Cornell'], 
  ...
  make(169, 'university', 'hard', ['topic:Window Functions', 'Partition By', 'company:Brown'], 
  ...
  make(170, 'university', 'hard', ['topic:CTEs', 'Self Join', 'company:Dartmouth'], 
  ...
  make(171, 'university', 'hard', ['topic:Window Functions', 'Math', 'company:UCBerkeley'], 
  ...
  make(172, 'university', 'hard', ['topic:CTEs', 'Data Analysis', 'company:UCLA'], 
  ...
  make(173, 'university', 'hard', ['topic:Window Functions', 'Ntile', 'company:UMich'], 
  ...
  make(174, 'university', 'hard', ['topic:CTEs', 'Self Join', 'company:UTAustin'], 
  ...
  make(175, 'university', 'hard', ['topic:CTEs', 'Data Analysis', 'company:UW'], 
  ...
  make(176, 'university', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:GeorgiaTech'], 
  ...
  make(177, 'university', 'hard', ['topic:CTEs', 'Null Handling', 'company:CMU'], 
  ...
  make(178, 'university', 'hard', ['topic:Window Functions', 'Rank', 'company:Purdue'], 
  ...
  make(179, 'university', 'hard', ['topic:Math', 'Data Analysis', 'company:UIUC'], 
  ...
  make(180, 'university', 'hard', ['topic:CTEs', 'Data Analysis', 'company:Caltech'], 
