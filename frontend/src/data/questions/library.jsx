...
export const libraryQuestions = [
  ...
  make(421, 'library', 'easy', ['topic:Basic SQL', 'Where', 'company:NYPL'], 
  ...
  make(422, 'library', 'easy', ['topic:String Functions', 'Basic SQL', 'company:BostonPublicLibrary'], 
  ...
  make(423, 'library', 'easy', ['topic:Math', 'Aggregate Functions', 'company:ChicagoPublicLibrary'], 
  ...
  make(424, 'library', 'easy', ['topic:Basic SQL', 'Null Handling', 'company:SFPublicLibrary'], 
  ...
  make(425, 'library', 'easy', ['topic:Data Analysis', 'Group By', 'company:SeattlePublicLibrary'], 
  ...
  make(426, 'library', 'easy', ['topic:Date Functions', 'Where', 'company:BrooklynPublicLibrary'], 
  ...
  make(427, 'library', 'easy', ['topic:Aggregate Functions', 'Math', 'company:QueensPublicLibrary'], 
  ...
  make(428, 'library', 'easy', ['topic:Basic SQL', 'Limit', 'company:LAPublicLibrary'], 
  ...
  make(429, 'library', 'easy', ['topic:Basic SQL', 'In', 'company:DenverPublicLibrary'], 
  ...
  make(430, 'library', 'easy', ['topic:String Functions', 'Basic SQL', 'company:FreeLibraryOfPhiladelphia'], 
  ...
  make(431, 'library', 'easy', ['topic:Data Analysis', 'Group By', 'company:NYPL'], 
  ...
  make(432, 'library', 'easy', ['topic:Date Functions', 'String Functions', 'company:BostonPublicLibrary'], 
  ...
  make(433, 'library', 'easy', ['topic:Basic SQL', 'Where', 'company:ChicagoPublicLibrary'], 
  ...
  make(434, 'library', 'easy', ['topic:Aggregate Functions', 'Distinct', 'company:SFPublicLibrary'], 
  ...
  make(435, 'library', 'easy', ['topic:Basic SQL', 'Math', 'company:SeattlePublicLibrary'], 
  ...
  make(436, 'library', 'easy', ['topic:Data Cleaning', 'Like', 'company:BrooklynPublicLibrary'], 
  ...
  make(437, 'library', 'easy', ['topic:Basic SQL', 'Where', 'company:QueensPublicLibrary'], 
  ...
  make(438, 'library', 'easy', ['topic:Aggregate Functions', 'Group By', 'company:LAPublicLibrary'], 
  ...
  make(439, 'library', 'easy', ['topic:Basic SQL', 'Order By', 'company:DenverPublicLibrary'], 
  ...
  make(440, 'library', 'easy', ['topic:Basic SQL', 'Where', 'company:FreeLibraryOfPhiladelphia'], 
  ...
  make(441, 'library', 'medium', ['topic:Joins', 'Data Analysis', 'company:NYPL'], 
  ...
  make(442, 'library', 'medium', ['topic:Joins', 'Math', 'company:BostonPublicLibrary'], 
  ...
  make(443, 'library', 'medium', ['topic:Subqueries', 'Data Analysis', 'company:ChicagoPublicLibrary'], 
  ...
  make(444, 'library', 'medium', ['topic:Joins', 'Group By', 'company:SFPublicLibrary'], 
  ...
  make(445, 'library', 'medium', ['topic:Case Statements', 'Math', 'company:SeattlePublicLibrary'], 
  ...
  make(446, 'library', 'medium', ['topic:Joins', 'Having', 'company:BrooklynPublicLibrary'], 
  ...
  make(447, 'library', 'medium', ['topic:Subqueries', 'Null Handling', 'company:QueensPublicLibrary'], 
  ...
  make(448, 'library', 'medium', ['topic:Date Functions', 'Math', 'company:LAPublicLibrary'], 
  ...
  make(449, 'library', 'medium', ['topic:Joins', 'Null Handling', 'company:DenverPublicLibrary'], 
  ...
  make(450, 'library', 'medium', ['topic:Joins', 'Data Analysis', 'company:FreeLibraryOfPhiladelphia'], 
  ...
  make(451, 'library', 'medium', ['topic:Subqueries', 'Math', 'company:NYPL'], 
  ...
  make(452, 'library', 'medium', ['topic:Joins', 'Group By', 'company:BostonPublicLibrary'], 
  ...
  make(453, 'library', 'medium', ['topic:Joins', 'Date Functions', 'company:ChicagoPublicLibrary'], 
  ...
  make(454, 'library', 'medium', ['topic:Case Statements', 'Data Analysis', 'company:SFPublicLibrary'], 
  ...
  make(455, 'library', 'medium', ['topic:CTEs', 'Data Analysis', 'company:SeattlePublicLibrary'], 
  ...
  make(456, 'library', 'medium', ['topic:Set Operations', 'Data Analysis', 'company:BrooklynPublicLibrary'], 
  ...
  make(457, 'library', 'medium', ['topic:Joins', 'Self Join', 'company:QueensPublicLibrary'], 
  ...
  make(458, 'library', 'medium', ['topic:Joins', 'Group By', 'company:LAPublicLibrary'], 
  ...
  make(459, 'library', 'medium', ['topic:Joins', 'Date Functions', 'company:DenverPublicLibrary'], 
  ...
  make(460, 'library', 'medium', ['topic:Math', 'Data Analysis', 'company:FreeLibraryOfPhiladelphia'], 
  ...
  make(461, 'library', 'medium', ['topic:Joins', 'Null Handling', 'company:NYPL'], 
  ...
  make(462, 'library', 'medium', ['topic:String Functions', 'Basic SQL', 'company:BostonPublicLibrary'], 
  ...
  make(463, 'library', 'medium', ['topic:Math', 'Date Functions', 'company:ChicagoPublicLibrary'], 
  ...
  make(464, 'library', 'medium', ['topic:Group By', 'Having', 'company:SFPublicLibrary'], 
  ...
  make(465, 'library', 'medium', ['topic:Joins', 'Data Analysis', 'company:SeattlePublicLibrary'], 
  ...
  make(466, 'library', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:BrooklynPublicLibrary'], 
  ...
  make(467, 'library', 'hard', ['topic:Window Functions', 'Rank', 'company:QueensPublicLibrary'], 
  ...
  make(468, 'library', 'hard', ['topic:CTEs', 'Window Functions', 'company:LAPublicLibrary'], 
  ...
  make(469, 'library', 'hard', ['topic:Window Functions', 'Partition By', 'company:DenverPublicLibrary'], 
  ...
  make(470, 'library', 'hard', ['topic:CTEs', 'Self Join', 'company:FreeLibraryOfPhiladelphia'], 
  ...
  make(471, 'library', 'hard', ['topic:Window Functions', 'Math', 'company:NYPL'], 
  ...
  make(472, 'library', 'hard', ['topic:CTEs', 'Data Analysis', 'company:BostonPublicLibrary'], 
  ...
  make(473, 'library', 'hard', ['topic:Window Functions', 'Ntile', 'company:ChicagoPublicLibrary'], 
  ...
  make(474, 'library', 'hard', ['topic:CTEs', 'Self Join', 'company:SFPublicLibrary'], 
  ...
  make(475, 'library', 'hard', ['topic:CTEs', 'Data Analysis', 'company:SeattlePublicLibrary'], 
  ...
  make(476, 'library', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:BrooklynPublicLibrary'], 
  ...
  make(477, 'library', 'hard', ['topic:CTEs', 'Null Handling', 'company:QueensPublicLibrary'], 
  ...
  make(478, 'library', 'hard', ['topic:Window Functions', 'Rank', 'company:LAPublicLibrary'], 
  ...
  make(479, 'library', 'hard', ['topic:Math', 'Data Analysis', 'company:DenverPublicLibrary'], 
  ...
  make(480, 'library', 'hard', ['topic:CTEs', 'Data Analysis', 'company:FreeLibraryOfPhiladelphia'], 
