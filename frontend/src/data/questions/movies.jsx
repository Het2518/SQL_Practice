...
export const moviesQuestions = [
  ...
  make(361, 'movies', 'easy', ['topic:Basic SQL', 'Where', 'company:Netflix'], 
  ...
  make(362, 'movies', 'easy', ['topic:String Functions', 'Basic SQL', 'company:Disney'], 
  ...
  make(363, 'movies', 'easy', ['topic:Math', 'Aggregate Functions', 'company:WarnerBros'], 
  ...
  make(364, 'movies', 'easy', ['topic:Basic SQL', 'Null Handling', 'company:Universal'], 
  ...
  make(365, 'movies', 'easy', ['topic:Data Analysis', 'Group By', 'company:Paramount'], 
  ...
  make(366, 'movies', 'easy', ['topic:Basic SQL', 'Where', 'company:SonyPictures'], 
  ...
  make(367, 'movies', 'easy', ['topic:Aggregate Functions', 'Math', 'company:Lionsgate'], 
  ...
  make(368, 'movies', 'easy', ['topic:Basic SQL', 'Limit', 'company:A24'], 
  ...
  make(369, 'movies', 'easy', ['topic:Basic SQL', 'In', 'company:MGM'], 
  ...
  make(370, 'movies', 'easy', ['topic:String Functions', 'Basic SQL', 'company:HBO'], 
  ...
  make(371, 'movies', 'easy', ['topic:Data Analysis', 'Group By', 'company:AmazonStudios'], 
  ...
  make(372, 'movies', 'easy', ['topic:Math', 'Data Analysis', 'company:AppleTV'], 
  ...
  make(373, 'movies', 'easy', ['topic:Basic SQL', 'Where', 'company:Hulu'], 
  ...
  make(374, 'movies', 'easy', ['topic:Aggregate Functions', 'Distinct', 'company:Peacock'], 
  ...
  make(375, 'movies', 'easy', ['topic:Basic SQL', 'Math', 'company:AMC'], 
  ...
  make(376, 'movies', 'easy', ['topic:Data Cleaning', 'Like', 'company:Cinemark'], 
  ...
  make(377, 'movies', 'easy', ['topic:Basic SQL', 'Where', 'company:Regal'], 
  ...
  make(378, 'movies', 'easy', ['topic:Aggregate Functions', 'Group By', 'company:IMDb'], 
  ...
  make(379, 'movies', 'easy', ['topic:Basic SQL', 'Order By', 'company:RottenTomatoes'], 
  ...
  make(380, 'movies', 'easy', ['topic:Basic SQL', 'Math', 'company:Metacritic'], 
  ...
  make(381, 'movies', 'medium', ['topic:Joins', 'Data Analysis', 'company:Netflix'], 
  ...
  make(382, 'movies', 'medium', ['topic:Joins', 'Math', 'company:Disney'], 
  ...
  make(383, 'movies', 'medium', ['topic:Subqueries', 'Data Analysis', 'company:WarnerBros'], 
  ...
  make(384, 'movies', 'medium', ['topic:Joins', 'Group By', 'company:Universal'], 
  ...
  make(385, 'movies', 'medium', ['topic:Case Statements', 'Math', 'company:Paramount'], 
  ...
  make(386, 'movies', 'medium', ['topic:Joins', 'Having', 'company:SonyPictures'], 
  ...
  make(387, 'movies', 'medium', ['topic:Subqueries', 'Null Handling', 'company:Lionsgate'], 
  ...
  make(388, 'movies', 'medium', ['topic:Math', 'Data Analysis', 'company:A24'], 
  ...
  make(389, 'movies', 'medium', ['topic:Joins', 'Null Handling', 'company:MGM'], 
  ...
  make(390, 'movies', 'medium', ['topic:Joins', 'Data Analysis', 'company:HBO'], 
  ...
  make(391, 'movies', 'medium', ['topic:Subqueries', 'Math', 'company:AmazonStudios'], 
  ...
  make(392, 'movies', 'medium', ['topic:Joins', 'Group By', 'company:AppleTV'], 
  ...
  make(393, 'movies', 'medium', ['topic:Joins', 'Date Functions', 'company:Hulu'], 
  ...
  make(394, 'movies', 'medium', ['topic:Case Statements', 'Data Analysis', 'company:Peacock'], 
  ...
  make(395, 'movies', 'medium', ['topic:CTEs', 'Data Analysis', 'company:AMC'], 
  ...
  make(396, 'movies', 'medium', ['topic:Set Operations', 'Data Analysis', 'company:Cinemark'], 
  ...
  make(397, 'movies', 'medium', ['topic:Joins', 'Data Analysis', 'company:Regal'], 
  ...
  make(398, 'movies', 'medium', ['topic:Joins', 'Group By', 'company:IMDb'], 
  ...
  make(399, 'movies', 'medium', ['topic:Joins', 'Math', 'company:RottenTomatoes'], 
  ...
  make(400, 'movies', 'medium', ['topic:Math', 'Data Analysis', 'company:Metacritic'], 
  ...
  make(401, 'movies', 'medium', ['topic:Joins', 'Null Handling', 'company:Netflix'], 
  ...
  make(402, 'movies', 'medium', ['topic:String Functions', 'Basic SQL', 'company:Disney'], 
  ...
  make(403, 'movies', 'medium', ['topic:Math', 'Data Analysis', 'company:WarnerBros'], 
  ...
  make(404, 'movies', 'medium', ['topic:Group By', 'Having', 'company:Universal'], 
  ...
  make(405, 'movies', 'medium', ['topic:Joins', 'Data Analysis', 'company:Paramount'], 
  ...
  make(406, 'movies', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:SonyPictures'], 
  ...
  make(407, 'movies', 'hard', ['topic:Window Functions', 'Rank', 'company:Lionsgate'], 
  ...
  make(408, 'movies', 'hard', ['topic:CTEs', 'Window Functions', 'company:A24'], 
  ...
  make(409, 'movies', 'hard', ['topic:Window Functions', 'Partition By', 'company:MGM'], 
  ...
  make(410, 'movies', 'hard', ['topic:CTEs', 'Self Join', 'company:HBO'], 
  ...
  make(411, 'movies', 'hard', ['topic:Window Functions', 'Math', 'company:AmazonStudios'], 
  ...
  make(412, 'movies', 'hard', ['topic:CTEs', 'Data Analysis', 'company:AppleTV'], 
  ...
  make(413, 'movies', 'hard', ['topic:Window Functions', 'Ntile', 'company:Hulu'], 
  ...
  make(414, 'movies', 'hard', ['topic:CTEs', 'Self Join', 'company:Peacock'], 
  ...
  make(415, 'movies', 'hard', ['topic:CTEs', 'Data Analysis', 'company:AMC'], 
  ...
  make(416, 'movies', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:Cinemark'], 
  ...
  make(417, 'movies', 'hard', ['topic:CTEs', 'Null Handling', 'company:Regal'], 
  ...
  make(418, 'movies', 'hard', ['topic:Window Functions', 'Rank', 'company:IMDb'], 
  ...
  make(419, 'movies', 'hard', ['topic:Math', 'Data Analysis', 'company:RottenTomatoes'], 
  ...
  make(420, 'movies', 'hard', ['topic:CTEs', 'Data Analysis', 'company:Metacritic'], 
