...
export const musicQuestions = [
  ...
  make(541, 'music', 'easy', ['topic:Basic SQL', 'Where', 'company:Spotify'], 
  ...
  make(542, 'music', 'easy', ['topic:String Functions', 'Basic SQL', 'company:AppleMusic'], 
  ...
  make(543, 'music', 'easy', ['topic:Math', 'Aggregate Functions', 'company:SoundCloud'], 
  ...
  make(544, 'music', 'easy', ['topic:Basic SQL', 'Null Handling', 'company:Tidal'], 
  ...
  make(545, 'music', 'easy', ['topic:Data Analysis', 'Group By', 'company:Pandora'], 
  ...
  make(546, 'music', 'easy', ['topic:Basic SQL', 'Where', 'company:AmazonMusic'], 
  ...
  make(547, 'music', 'easy', ['topic:Aggregate Functions', 'Math', 'company:Spotify'], 
  ...
  make(548, 'music', 'easy', ['topic:Basic SQL', 'Limit', 'company:AppleMusic'], 
  ...
  make(549, 'music', 'easy', ['topic:Basic SQL', 'In', 'company:SoundCloud'], 
  ...
  make(550, 'music', 'easy', ['topic:String Functions', 'Basic SQL', 'company:Tidal'], 
  ...
  make(551, 'music', 'easy', ['topic:Data Analysis', 'Group By', 'company:Pandora'], 
  ...
  make(552, 'music', 'easy', ['topic:Date Functions', 'String Functions', 'company:AmazonMusic'], 
  ...
  make(553, 'music', 'easy', ['topic:Basic SQL', 'Where', 'company:Spotify'], 
  ...
  make(554, 'music', 'easy', ['topic:Aggregate Functions', 'Distinct', 'company:AppleMusic'], 
  ...
  make(555, 'music', 'easy', ['topic:Basic SQL', 'Math', 'company:SoundCloud'], 
  ...
  make(556, 'music', 'easy', ['topic:Data Cleaning', 'Like', 'company:Tidal'], 
  ...
  make(557, 'music', 'easy', ['topic:Basic SQL', 'Where', 'company:Pandora'], 
  ...
  make(558, 'music', 'easy', ['topic:Aggregate Functions', 'Group By', 'company:AmazonMusic'], 
  ...
  make(559, 'music', 'easy', ['topic:Basic SQL', 'Order By', 'company:Spotify'], 
  ...
  make(560, 'music', 'easy', ['topic:Basic SQL', 'Math', 'company:AppleMusic'], 
  ...
  make(561, 'music', 'medium', ['topic:Joins', 'Data Analysis', 'company:SoundCloud'], 
  ...
  make(562, 'music', 'medium', ['topic:Joins', 'Math', 'company:Tidal'], 
  ...
  make(563, 'music', 'medium', ['topic:Subqueries', 'Data Analysis', 'company:Pandora'], 
  ...
  make(564, 'music', 'medium', ['topic:Joins', 'Group By', 'company:AmazonMusic'], 
  ...
  make(565, 'music', 'medium', ['topic:Case Statements', 'Math', 'company:Spotify'], 
  ...
  make(566, 'music', 'medium', ['topic:Joins', 'Having', 'company:AppleMusic'], 
  ...
  make(567, 'music', 'medium', ['topic:Subqueries', 'Null Handling', 'company:SoundCloud'], 
  ...
  make(568, 'music', 'medium', ['topic:Math', 'Data Analysis', 'company:Tidal'], 
  ...
  make(569, 'music', 'medium', ['topic:Joins', 'Null Handling', 'company:Pandora'], 
  ...
  make(570, 'music', 'medium', ['topic:Joins', 'Data Analysis', 'company:AmazonMusic'], 
  ...
  make(571, 'music', 'medium', ['topic:Subqueries', 'Math', 'company:Spotify'], 
  ...
  make(572, 'music', 'medium', ['topic:Joins', 'Group By', 'company:AppleMusic'], 
  ...
  make(573, 'music', 'medium', ['topic:Joins', 'Date Functions', 'company:SoundCloud'], 
  ...
  make(574, 'music', 'medium', ['topic:Case Statements', 'Data Analysis', 'company:Tidal'], 
  ...
  make(575, 'music', 'medium', ['topic:CTEs', 'Data Analysis', 'company:Pandora'], 
  ...
  make(576, 'music', 'medium', ['topic:Set Operations', 'Data Analysis', 'company:AmazonMusic'], 
  ...
  make(577, 'music', 'medium', ['topic:Joins', 'Self Join', 'company:Spotify'], 
  ...
  make(578, 'music', 'medium', ['topic:Joins', 'Group By', 'company:AppleMusic'], 
  ...
  make(579, 'music', 'medium', ['topic:Joins', 'Math', 'company:SoundCloud'], 
  ...
  make(580, 'music', 'medium', ['topic:Math', 'Data Analysis', 'company:Tidal'], 
  ...
  make(581, 'music', 'medium', ['topic:Joins', 'Null Handling', 'company:Pandora'], 
  ...
  make(582, 'music', 'medium', ['topic:String Functions', 'Basic SQL', 'company:AmazonMusic'], 
  ...
  make(583, 'music', 'medium', ['topic:Math', 'Data Analysis', 'company:Spotify'], 
  ...
  make(584, 'music', 'medium', ['topic:Group By', 'Having', 'company:AppleMusic'], 
  ...
  make(585, 'music', 'medium', ['topic:Joins', 'Data Analysis', 'company:SoundCloud'], 
  ...
  make(586, 'music', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:Tidal'], 
  ...
  make(587, 'music', 'hard', ['topic:Window Functions', 'Rank', 'company:Pandora'], 
  ...
  make(588, 'music', 'hard', ['topic:CTEs', 'Window Functions', 'company:AmazonMusic'], 
  ...
  make(589, 'music', 'hard', ['topic:Window Functions', 'Partition By', 'company:Spotify'], 
  ...
  make(590, 'music', 'hard', ['topic:CTEs', 'Self Join', 'company:AppleMusic'], 
  ...
  make(591, 'music', 'hard', ['topic:Window Functions', 'Math', 'company:SoundCloud'], 
  ...
  make(592, 'music', 'hard', ['topic:CTEs', 'Data Analysis', 'company:Tidal'], 
  ...
  make(593, 'music', 'hard', ['topic:Window Functions', 'Ntile', 'company:Pandora'], 
  ...
  make(594, 'music', 'hard', ['topic:CTEs', 'Self Join', 'company:AmazonMusic'], 
  ...
  make(595, 'music', 'hard', ['topic:CTEs', 'Data Analysis', 'company:Spotify'], 
  ...
  make(596, 'music', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:AppleMusic'], 
  ...
  make(597, 'music', 'hard', ['topic:CTEs', 'Null Handling', 'company:SoundCloud'], 
  ...
  make(598, 'music', 'hard', ['topic:Window Functions', 'Rank', 'company:Tidal'], 
  ...
  make(599, 'music', 'hard', ['topic:Math', 'Data Analysis', 'company:Pandora'], 
  ...
  make(600, 'music', 'hard', ['topic:CTEs', 'Data Analysis', 'company:AmazonMusic'], 
