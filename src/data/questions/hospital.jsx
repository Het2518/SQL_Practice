...
// ══════════════════════════════════════════════
{
  ...
  db: 'hospital',
  difficulty: 'easy',
  keywords: ['Select', 'Where', 'Null Handling'],
...
// ══════════════════════════════════════════════
{
  ...
  db: 'hospital',
  difficulty: 'medium',
  keywords: ['Select', 'Join', 'Group By', 'Having'],
  ...
  db: 'hospital',
  difficulty: 'medium',
  keywords: ['Join', 'Group By', 'Date Function'],
  ...
  db: 'hospital',
  difficulty: 'medium',
  keywords: ['Group By', 'Date Function'],
  ...
  db: 'hospital',
  difficulty: 'medium',
  keywords: ['Join', 'Where', 'Date Function'],
  ...
  db: 'hospital',
  difficulty: 'medium',
  keywords: ['Select', 'String Function'],
  ...
  db: 'hospital',
  difficulty: 'medium',
  keywords: ['Subquery', 'Group By', 'Having'],
...
// ══════════════════════════════════════════════
{
  ...
  db: 'hospital',
  difficulty: 'hard',
  keywords: ['Window Function', 'Rank', 'Join'],
  ...
  db: 'hospital',
  difficulty: 'hard',
  keywords: ['CTE', 'Window Function', 'Rank', 'Join'],
  ...
  db: 'hospital',
  difficulty: 'hard',
  keywords: ['Window Function', 'Lag', 'Date Function'],
  ...
  db: 'hospital',
  difficulty: 'hard',
  keywords: ['CTE', 'Window Function', 'Join'],
  ...
  db: 'hospital',
  difficulty: 'hard',
  keywords: ['CTE', 'Window Function', 'Date Function'],
  ...
  db: 'hospital',
  difficulty: 'hard',
  keywords: ['Window Function', 'Rank', 'CTE'],
