...
export const hrQuestions = [
  ...
  make(1, 'hr', 'easy', ['topic:Basic SQL', 'Where', 'company:LinkedIn'], 
  ...
  make(2, 'hr', 'easy', ['topic:String Functions', 'Basic SQL', 'company:Google'], 
  ...
  make(3, 'hr', 'easy', ['topic:Aggregate Functions', 'Math', 'company:Microsoft'], 
  ...
  make(4, 'hr', 'easy', ['topic:Basic SQL', 'Null Handling', 'company:Apple'], 
  ...
  make(5, 'hr', 'easy', ['topic:Data Analysis', 'Group By', 'company:Netflix'], 
  ...
  make(6, 'hr', 'easy', ['topic:Date Functions', 'Where', 'company:Amazon'], 
  ...
  make(7, 'hr', 'easy', ['topic:Aggregate Functions', 'Math', 'company:Meta'], 
  ...
  make(8, 'hr', 'easy', ['topic:Basic SQL', 'Limit', 'company:Airbnb'], 
  ...
  make(9, 'hr', 'easy', ['topic:Basic SQL', 'In', 'company:Uber'], 
  ...
  make(10, 'hr', 'easy', ['topic:String Functions', 'Basic SQL', 'company:Databricks'], 
  ...
  make(11, 'hr', 'easy', ['topic:Data Analysis', 'Group By', 'company:Oracle'], 
  ...
  make(12, 'hr', 'easy', ['topic:Date Functions', 'String Functions', 'company:Salesforce'], 
  ...
  make(13, 'hr', 'easy', ['topic:Basic SQL', 'Where', 'company:Snowflake'], 
  ...
  make(14, 'hr', 'easy', ['topic:Aggregate Functions', 'Distinct', 'company:Stripe'], 
  ...
  make(15, 'hr', 'easy', ['topic:Basic SQL', 'Math', 'company:PayPal'], 
  ...
  make(16, 'hr', 'easy', ['topic:Data Cleaning', 'Like', 'company:Square'], 
  ...
  make(17, 'hr', 'easy', ['topic:Basic SQL', 'Where', 'company:Robinhood'], 
  ...
  make(18, 'hr', 'easy', ['topic:Aggregate Functions', 'Group By', 'company:Zoom'], 
  ...
  make(19, 'hr', 'easy', ['topic:Basic SQL', 'Order By', 'company:Slack'], 
  ...
  make(20, 'hr', 'easy', ['topic:Math', 'Aggregate Functions', 'company:Asana'], 
  ...
  make(21, 'hr', 'medium', ['topic:Joins', 'Math', 'company:LinkedIn'], 
  ...
  make(22, 'hr', 'medium', ['topic:Joins', 'Data Analysis', 'company:Google'], 
  ...
  make(23, 'hr', 'medium', ['topic:Self Join', 'Data Analysis', 'company:Microsoft'], 
  ...
  make(24, 'hr', 'medium', ['topic:Joins', 'Group By', 'company:Apple'], 
  ...
  make(25, 'hr', 'medium', ['topic:Case Statements', 'Data Analysis', 'company:Netflix'], 
  ...
  make(26, 'hr', 'medium', ['topic:Joins', 'Having', 'company:Amazon'], 
  ...
  make(27, 'hr', 'medium', ['topic:Subqueries', 'Null Handling', 'company:Meta'], 
  ...
  make(28, 'hr', 'medium', ['topic:Date Functions', 'Math', 'company:Airbnb'], 
  ...
  make(29, 'hr', 'medium', ['topic:Joins', 'Math', 'company:Uber'], 
  ...
  make(30, 'hr', 'medium', ['topic:Joins', 'Null Handling', 'company:Databricks'], 
  ...
  make(31, 'hr', 'medium', ['topic:Subqueries', 'Data Analysis', 'company:Oracle'], 
  ...
  make(32, 'hr', 'medium', ['topic:Joins', 'Data Analysis', 'company:Salesforce'], 
  ...
  make(33, 'hr', 'medium', ['topic:Joins', 'Date Functions', 'company:Snowflake'], 
  ...
  make(34, 'hr', 'medium', ['topic:Case Statements', 'Math', 'company:Stripe'], 
  ...
  make(35, 'hr', 'medium', ['topic:CTEs', 'Data Analysis', 'company:PayPal'], 
  ...
  make(36, 'hr', 'medium', ['topic:Set Operations', 'Data Analysis', 'company:Square'], 
  ...
  make(37, 'hr', 'medium', ['topic:Joins', 'Self Join', 'company:Robinhood'], 
  ...
  make(38, 'hr', 'medium', ['topic:Math', 'Data Analysis', 'company:Zoom'], 
  ...
  make(39, 'hr', 'medium', ['topic:Joins', 'Date Functions', 'company:Slack'], 
  ...
  make(40, 'hr', 'medium', ['topic:Joins', 'Data Analysis', 'company:Asana'], 
  ...
  make(41, 'hr', 'medium', ['topic:String Functions', 'Basic SQL', 'company:LinkedIn'], 
  ...
  make(42, 'hr', 'medium', ['topic:Joins', 'Group By', 'company:Google'], 
  ...
  make(43, 'hr', 'medium', ['topic:Math', 'Data Analysis', 'company:Microsoft'], 
  ...
  make(44, 'hr', 'medium', ['topic:Joins', 'Data Analysis', 'company:Apple'], 
  ...
  make(45, 'hr', 'medium', ['topic:Group By', 'Having', 'company:Netflix'], 
  ...
  make(46, 'hr', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:Amazon'], 
  ...
  make(47, 'hr', 'hard', ['topic:Window Functions', 'Rank', 'company:Meta'], 
  ...
  make(48, 'hr', 'hard', ['topic:CTEs', 'Window Functions', 'company:Airbnb'], 
  ...
  make(49, 'hr', 'hard', ['topic:Window Functions', 'Partition By', 'company:Uber'], 
  ...
  make(50, 'hr', 'hard', ['topic:CTEs', 'Self Join', 'company:Databricks'], 
  ...
  make(51, 'hr', 'hard', ['topic:Window Functions', 'Math', 'company:Oracle'], 
  ...
  make(52, 'hr', 'hard', ['topic:CTEs', 'Data Analysis', 'company:Salesforce'], 
  ...
  make(53, 'hr', 'hard', ['topic:Window Functions', 'Ntile', 'company:Snowflake'], 
  ...
  make(54, 'hr', 'hard', ['topic:CTEs', 'Self Join', 'company:Stripe'], 
  ...
  make(55, 'hr', 'hard', ['topic:CTEs', 'Data Analysis', 'company:PayPal'], 
  ...
  make(56, 'hr', 'hard', ['topic:Window Functions', 'Lead/Lag', 'company:Square'], 
  ...
  make(57, 'hr', 'hard', ['topic:CTEs', 'Null Handling', 'company:Robinhood'], 
  ...
  make(58, 'hr', 'hard', ['topic:Window Functions', 'Rank', 'company:Zoom'], 
  ...
  make(59, 'hr', 'hard', ['topic:Math', 'Data Analysis', 'company:Slack'], 
  ...
  make(60, 'hr', 'hard', ['topic:CTEs', 'Data Analysis', 'company:Asana'], 
