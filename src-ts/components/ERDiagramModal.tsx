...
import { DB_INFO, type DatabaseName } from '../types';
...
export function ERDiagramModal({ dbName, onClose }: ERDiagramModalProps) {
  ...
  return (
    <div 
      ...
      onClick={onClose} 
      style={{ padding: 40, zIndex: 9999, background: 'rgba(0,0,0,0.85)' }}
    >
      <div 
      ...
      >
        <div style={{ padding: '16px 24px', background: 'var(--surface-2)', borderBottom: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
          ...
          <button className="btn btn-ghost" onClick={onClose} style={{ fontSize: 14 }}>✕ Close</button>
        </div>
