...
export const hospitalQuestions: Question[] = [
  ...
  // ══════════════════════════════════════════════
  {
    ...
    expectedResult: {
      ...
      rows: [
        ['John','Smith','M'],['Maria','Garcia','F'],['James','Johnson','M'],
        ['Emily','Brown','F'],['Robert','Davis','M'],['Linda','Wilson','F'],
        ['Michael','Martinez','M'],['Barbara','Taylor','F'],['Charles','Anderson','M'],
        ['Jennifer','Thomas','F'],['Daniel','Jackson','M'],['Susan','White','F'],
        ['Matthew','Harris','M'],['Karen','Martin','F'],['Anthony','Thompson','M'],
        ['Lisa','Garcia','F'],['Mark','Martinez','M'],['Nancy','Robinson','F'],
        ['Paul','Clark','M'],['Sandra','Rodriguez','F'],['Kevin','Lewis','M'],
        ['Betty','Lee','F'],['George','Walker','M'],['Donna','Hall','F'],
        ['Ronald','Allen','M'],['Carol','Young','F'],['Kenneth','Hernandez','M'],
        ['Ruth','King','F'],['Steven','Rodriguez','M'],['Sharon','Lopez','F'],
        ['Edward','Hill','M'],['Deborah','Scott','F'],['Brian','Green','M'],
        ['Rachel','Adams','F'],['Timothy','Baker','M'],['Carolyn','Gonzalez','F'],
        ['Jeffrey','Nelson','M'],['Amy','Carter','F'],['Gary','Mitchell','M'],
        ['Anna','Perez','F'],['Frank','Roberts','M'],['Melissa','Turner','F'],
        ['Eric','Phillips','M'],['Debra','Campbell','F'],['Walter','Parker','M'],
        ['Stephanie','Evans','F'],['Peter','Edwards','M'],['Rebecca','Collins','F'],
        ['Henry','Stewart','M'],['Virginia','Sanchez','F'],['Jack','Morris','M'],
        ['Jacqueline','Rogers','F'],['Albert','Reed','M'],['Maria','Cook','F'],
        ['Terry','Morgan','M'],['Judith','Bell','F'],['Sean','Murphy','M'],
        ['Kelly','Bailey','F'],['Donald','Rivera','M'],['Christine','Cooper','F'],
        ['Larry','Richardson','M'],['Helen','Cox','F'],['Joe','Howard','M'],
        ['Joan','Ward','F'],['Todd','Torres','M'],['Evelyn','Peterson','F'],
        ['Carl','Gray','M'],['Angela','Ramirez','F'],['Arthur','James','M'],
        ['Katherine','Watson','F'],['Keith','Brooks','M'],['Shirley','Kelly','F'],
        ['Douglas','Sanders','M'],['Carolyn','Price','F'],['Lawrence','Bennett','M'],
        ['Lori','Wood','F'],['Jesse','Barnes','M'],['Theresa','Ross','F'],
        ['Harold','Henderson','M'],['Alice','Coleman','F'],['Ralph','Jenkins','M'],
        ['Frances','Perry','F'],['Ryan','Powell','M'],['Virginia','Long','F'],
        ['Roy','Patterson','M'],['Joyce','Hughes','F'],['Eugene','Flores','M'],
        ['Gloria','Washington','F'],['Wayne','Butler','M'],['Mildred','Simmons','F'],
        ['Randy','Foster','M'],['Phyllis','Gonzales','F'],['Louis','Bryant','M'],
        ['Debra','Alexander','F'],['Dennis','Russell','M'],['Cheryl','Griffin','F'],
        ['Clarence','Diaz','M'],['Julie','Hayes','F'],['Victor','Myers','M'],
        ['Martha','Ford','F'],
      ],
    },
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        [1,'John','Smith'],[3,'James','Johnson'],[5,'Robert','Davis'],
        [7,'Michael','Martinez'],[9,'Charles','Anderson'],[11,'Daniel','Jackson'],
        [13,'Matthew','Harris'],[15,'Anthony','Thompson'],[17,'Mark','Martinez'],
        [19,'Paul','Clark'],[21,'Kevin','Lewis'],[23,'George','Walker'],
        [25,'Ronald','Allen'],[27,'Kenneth','Hernandez'],[29,'Steven','Rodriguez'],
        [31,'Edward','Hill'],[33,'Brian','Green'],[35,'Timothy','Baker'],
        [37,'Jeffrey','Nelson'],[39,'Gary','Mitchell'],[41,'Frank','Roberts'],
        [43,'Eric','Phillips'],[45,'Walter','Parker'],[47,'Peter','Edwards'],
        [49,'Henry','Stewart'],[51,'Jack','Morris'],[53,'Albert','Reed'],
        [55,'Terry','Morgan'],[57,'Sean','Murphy'],[59,'Donald','Rivera'],
        [61,'Larry','Richardson'],[63,'Joe','Howard'],[65,'Todd','Torres'],
        [67,'Carl','Gray'],[69,'Arthur','James'],[71,'Keith','Brooks'],
        [73,'Douglas','Sanders'],[75,'Lawrence','Bennett'],[77,'Jesse','Barnes'],
        [79,'Harold','Henderson'],[81,'Ralph','Jenkins'],[83,'Ryan','Powell'],
        [85,'Roy','Patterson'],[87,'Eugene','Flores'],[89,'Wayne','Butler'],
        [91,'Randy','Foster'],[93,'Louis','Bryant'],[95,'Dennis','Russell'],
        [97,'Clarence','Diaz'],[99,'Victor','Myers'],
      ],
    },
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        ['Maria','Garcia','Penicillin'],['Linda','Wilson','Penicillin'],
        ['Anthony','Thompson','Penicillin'],['Sandra','Rodriguez','Penicillin'],
        ['Frank','Roberts','Penicillin'],['Terry','Morgan','Penicillin'],
        ['Ryan','Powell','Penicillin'],['Victor','Myers','Penicillin'],
      ],
    },
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        ['Emily','Brown','1990-01-30'],['Anna','Perez','1990-04-18'],
        ['Joyce','Hughes','1990-03-20'],['Maria','Garcia','1992-07-24'],
        ['Jack','Morris','1992-08-25'],['Lisa','Garcia','1993-06-30'],
        ['Melissa','Turner','1993-02-22'],['Angela','Ramirez','1993-09-14'],
        ['Deborah','Scott','1994-04-02'],['Debra','Alexander','1994-07-06'],
        ['Michael','Martinez','1995-04-14'],['Maria','Cook','1995-11-16'],
        ['Carol','Young','1991-01-16'],['Julie','Hayes','1995-03-14'],
        ['Carolyn','Gonzalez','1996-10-10'],['Frances','Perry','1996-07-12'],
        ['Sandra','Rodriguez','1997-08-13'],['Carolyn','Price','1997-03-26'],
        ['Helen','Cox','1997-03-02'],['Jennifer','Thomas','1998-02-27'],
        ['Rebecca','Collins','1999-07-04'],['Steven','Rodriguez','1999-02-11'],
        ['Virginia','Sanchez','1986-04-08'],['Stephanie','Evans','1988-09-30'],
        ['Alice','Coleman','1989-09-08'],['Kelly','Bailey','1990-07-24'],
  ...
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        ['John','Smith'],['James','Johnson'],['Jennifer','Thomas'],
        ['Jeffrey','Nelson'],['Jack','Morris'],['Jacqueline','Rogers'],
        ['Judith','Bell'],['Joe','Howard'],['Joan','Ward'],
        ['Jesse','Barnes'],['Julie','Hayes'],['Joyce','Hughes'],
      ],
    },
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        ['John','Smith',82.5],['Linda','Wilson',70.1],['Daniel','Jackson',84.7],
        ['Susan','White',73.5],['Anthony','Thompson',79.6],['Mark','Martinez',87.1],
        ['Donna','Hall',71.7],['Ronald','Allen',85.4],['Kevin','Lewis',80.3],
        ['George','Walker',null],['Ruth','King',null],['Brian','Green',86.2],
        ['Jeffrey','Nelson',88.7],['Frank','Roberts',null],['Melissa','Turner',70.3],
        ['Debra','Campbell',null],['Peter','Edwards',84.0],['Jack','Morris',75.8],
        ['Albert','Reed',82.3],['Terry','Morgan',86.7],['Judith','Bell',null],
        ['Larry','Richardson',80.1],['Carl','Gray',85.8],['Ralph','Jenkins',81.7],
        ['Ryan','Powell',87.9],['Eugene','Flores',85.0],['Wayne','Butler',null],
        ['Randy','Foster',88.3],['Louis','Bryant',84.8],['Clarence','Diaz',82.6],
      ].filter(r => {
        const w = r[2] as number | null;
  ...
  },
  {
    ...
    expectedResult: {
      columns: ['city'],
      rows: [
        ['Calgary'],['Edmonton'],['Fredericton'],['Halifax'],['Montreal'],
        ['Ottawa'],['Saskatoon'],["St. John's"],['Toronto'],['Vancouver'],['Winnipeg'],
      ],
    },
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        [1,'John','Smith'],[3,'James','Johnson'],[5,'Robert','Davis'],
        [8,'Barbara','Taylor'],[9,'Charles','Anderson'],[11,'Daniel','Jackson'],
        [13,'Matthew','Harris'],[14,'Karen','Martin'],[16,'Lisa','Garcia'],
        [17,'Mark','Martinez'],[19,'Paul','Clark'],[21,'Kevin','Lewis'],
        [22,'Betty','Lee'],[23,'George','Walker'],[26,'Carol','Young'],
        [27,'Kenneth','Hernandez'],[28,'Ruth','King'],[30,'Sharon','Lopez'],
        [33,'Brian','Green'],[36,'Carolyn','Gonzalez'],[37,'Jeffrey','Nelson'],
        [39,'Gary','Mitchell'],[40,'Anna','Perez'],[42,'Melissa','Turner'],
        [43,'Eric','Phillips'],[45,'Walter','Parker'],[46,'Stephanie','Evans'],
        [47,'Peter','Edwards'],[49,'Henry','Stewart'],[50,'Virginia','Sanchez'],
        [51,'Jack','Morris'],[53,'Albert','Reed'],[54,'Maria','Cook'],
        [56,'Judith','Bell'],[57,'Sean','Murphy'],[60,'Christine','Cooper'],
        [61,'Larry','Richardson'],[63,'Joe','Howard'],[64,'Joan','Ward'],
        [66,'Evelyn','Peterson'],[67,'Carl','Gray'],[68,'Angela','Ramirez'],
        [70,'Katherine','Watson'],[71,'Keith','Brooks'],[72,'Shirley','Kelly'],
        [74,'Carolyn','Price'],[75,'Lawrence','Bennett'],[76,'Lori','Wood'],
        [77,'Jesse','Barnes'],[78,'Theresa','Ross'],[79,'Harold','Henderson'],
        [80,'Alice','Coleman'],[81,'Ralph','Jenkins'],[82,'Frances','Perry'],
        [84,'Virginia','Long'],[85,'Roy','Patterson'],[86,'Joyce','Hughes'],
        [87,'Eugene','Flores'],[89,'Wayne','Butler'],[90,'Mildred','Simmons'],
        [91,'Randy','Foster'],[93,'Louis','Bryant'],[94,'Debra','Alexander'],
        [96,'Cheryl','Griffin'],[97,'Clarence','Diaz'],[98,'Julie','Hayes'],
        [100,'Martha','Ford'],
      ],
    },
  },
  {
    ...
    expectedResult: {
      columns: ['first_name', 'last_name', 'weight'],
      rows: [
        ['George','Walker',96.5],['Donald','Rivera',95.3],['Walter','Parker',93.4],
        ['Dennis','Russell',91.5],['Roy','Patterson',92.2],['Keith','Brooks',92.6],
        ['Charles','Anderson',91.2],['Wayne','Butler',90.8],['Arthur','James',90.2],
        ['Kenneth','Hernandez',89.8],
      ],
    },
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        ['John','Smith','Cardiologist'],['Sarah','Johnson','Neurologist'],
        ['Michael','Brown','Orthopedic Surgeon'],['Emily','Davis','Oncologist'],
        ['Robert','Wilson','Emergency Physician'],['Linda','Martinez','Pediatrician'],
        ['James','Anderson','General Practitioner'],['Patricia','Taylor','Cardiologist'],
        ['Charles','Thomas','Neurologist'],['Barbara','Jackson','Radiologist'],
        ['Christopher','White','Oncologist'],['Jennifer','Harris','Pediatrician'],
        ['Daniel','Martin','Emergency Physician'],['Susan','Thompson','General Practitioner'],
        ['Matthew','Garcia','Orthopedic Surgeon'],['Karen','Martinez','Cardiologist'],
        ['Anthony','Robinson','Neurologist'],['Lisa','Clark','General Practitioner'],
        ['Mark','Rodriguez','Oncologist'],['Nancy','Lewis','Pediatrician'],
      ],
    },
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        ...
        [4,'Oncology'],[5,'Emergency'],[6,'Pediatrics'],
        [7,'General Medicine'],[8,'Radiology'],
      ],
    },
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        [13,13,'2023-01-10','Appendicitis'],[14,14,'2023-02-05','Arthritis'],
        [15,15,'2023-03-01','Hypertension'],[16,16,'2023-04-15','Migraine'],
        [17,17,'2023-05-10','Diabetes'],[18,18,'2023-06-05','Bronchitis'],
        [19,19,'2023-07-20','Fracture'],[20,20,'2023-08-15','Pneumonia'],
        [21,21,'2023-09-10','Hypertension'],[22,22,'2023-10-01','Diabetes'],
        [23,23,'2023-11-15','Stroke'],[24,24,'2023-12-05','Arthritis'],
        [31,1,'2023-03-12','Arrhythmia'],[32,2,'2023-05-22','Migraine'],
        [35,5,'2023-11-05','Hernia'],[37,7,'2023-08-12','Diabetes Type 2'],
        [39,9,'2023-04-30','TIA'],[40,10,'2023-07-01',null],
        [42,12,'2023-07-25','Diabetes'],[43,13,'2023-08-01','Appendicitis'],
        [54,41,'2023-03-25','Diabetes'],[55,42,'2023-04-10','Arthritis'],
        [56,43,'2023-05-20','Hypertension'],[57,44,'2023-06-15','Migraine'],
        [58,45,'2023-07-05','Heart Failure'],[59,46,'2023-08-20','Bronchitis'],
        [60,47,'2023-09-10','Fracture'],[61,48,'2023-10-25','Pneumonia'],
        [62,49,'2023-11-15','COPD'],[63,50,'2023-12-01','Diabetes'],
        [89,76,'2023-01-25','Anemia'],[90,77,'2023-02-20','Hypertension'],
        [91,78,'2023-03-15','Diabetes'],[92,79,'2023-04-01','COPD'],
        [93,80,'2023-05-10','Pneumonia'],[94,81,'2023-06-05','Arthritis'],
        [95,82,'2023-07-20','Migraine'],[96,83,'2023-08-10','Hypertension'],
        [97,84,'2023-09-05','Diabetes'],[98,85,'2023-10-20','Heart Failure'],
        [99,86,'2023-11-10','Fracture'],[100,87,'2023-12-05','Stroke'],
        [114,14,'2023-03-10','Hypertension'],[115,30,'2022-09-01',null],
      ].filter(r => String(r[2]).startsWith('2023')),
    },
  },
  {
    id: 14,
    ...
    expectedResult: {
      ...
      rows: [
        ...
        ['AB','Alberta','Canada'],['QC','Quebec','Canada'],
        ['MB','Manitoba','Canada'],['SK','Saskatchewan','Canada'],
        ['NS','Nova Scotia','Canada'],['NB','New Brunswick','Canada'],
        ['NL','Newfoundland and Labrador','Canada'],['PE','Prince Edward Island','Canada'],
        ['NY','New York','USA'],['CA','California','USA'],
        ['TX','Texas','USA'],['FL','Florida','USA'],['WA','Washington','USA'],
      ],
    },
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        ['ON',20],['BC',20],['AB',17],['QC',10],['MB',9],['ON',null],
      ].filter(() => false), // computed from data
    },
  },
  {
    id: 16,
    ...
    expectedResult: { columns: ['admission_id','patient_id','admission_date','diagnosis'], rows: [] },
  },
  {
    id: 17,
    db: 'hospital',
  ...
  },
  {
    ...
    expectedResult: {
      ...
      rows: [
        ['Charles','Anderson',188],['Donald','Rivera',188],['George','Walker',null],
      ].filter(() => false),
    },
  },
  {
  ...
  },
  {
    ...
    expectedResult: {
      columns: ['admission_id', 'patient_id', 'admission_date', 'diagnosis'],
      rows: [
        [7,7,'2022-07-01','Diabetes'],[12,12,'2022-12-20','Diabetes'],
        [17,17,'2023-05-10','Diabetes'],[22,22,'2023-10-01','Diabetes'],
        [42,12,'2023-07-25','Diabetes'],[46,33,'2022-07-15','Diabetes'],
        [63,50,'2023-12-01','Diabetes'],[74,61,'2024-03-05','Diabetes'],
        [81,68,'2022-05-15','Diabetes'],[91,78,'2023-03-15','Diabetes'],
        [97,84,'2023-09-05','Diabetes'],[106,93,'2024-06-15','Diabetes'],
        [113,100,'2024-05-10','Diabetes'],
      ],
    },
  },
  // ══════════════════════════════════════════════
  ...
  // ══════════════════════════════════════════════
  {
    ...
    expectedResult: { columns: ['patient_id','first_name','last_name','last_admission_date'], rows: [] },
  },
  {
    id: 22,
    db: 'hospital',
    ...
    expectedResult: { columns: ['patient_id','first_name','last_name','admission_count'], rows: [] },
  },
  {
    id: 23,
    db: 'hospital',
    ...
    expectedResult: { columns: ['doctor_id','first_name','last_name','admission_count'], rows: [] },
  },
  {
    id: 24,
    db: 'hospital',
    ...
    expectedResult: { columns: ['admission_id','patient_name','doctor_name','diagnosis'], rows: [] },
  },
  {
    id: 25,
    db: 'hospital',
    ...
    expectedResult: { columns: ['department_name','doctor_count'], rows: [] },
  },
  {
    id: 26,
    db: 'hospital',
    ...
    expectedResult: { columns: ['admission_id','patient_id','admission_date','discharge_date'], rows: [] },
  },
  {
    id: 27,
    db: 'hospital',
    ...
    expectedResult: { columns: ['department_name','avg_stay_days'], rows: [] },
  },
  {
    id: 28,
    db: 'hospital',
    ...
    expectedResult: { columns: ['first_name','last_name','admission_count'], rows: [] },
  },
  {
    id: 29,
    db: 'hospital',
    ...
    expectedResult: { columns: ['month','admission_count'], rows: [] },
  },
  {
    id: 30,
    db: 'hospital',
    ...
    expectedResult: { columns: ['admission_id','patient_name','age_at_admission','admission_date'], rows: [] },
  },
  {
    id: 31,
    db: 'hospital',
    ...
    expectedResult: { columns: ['doctor_id','first_name','last_name','specialty'], rows: [] },
  },
  {
    id: 32,
    db: 'hospital',
    ...
    expectedResult: { columns: ['first_name','last_name','admission_date','diagnosis'], rows: [] },
  },
  {
    id: 33,
    db: 'hospital',
    ...
    expectedResult: { columns: ['diagnosis','diagnosis_count'], rows: [] },
  },
  {
    id: 34,
    db: 'hospital',
  ...
  },
  {
    ...
    expectedResult: { columns: ['admission_id','admission_date','discharge_date','days_stayed'], rows: [] },
  },
  {
    id: 36,
    db: 'hospital',
    ...
    expectedResult: { columns: ['province_name','patient_count'], rows: [] },
  },
  {
    id: 37,
    db: 'hospital',
    ...
    expectedResult: { columns: ['first_name','last_name','weight'], rows: [] },
  },
  {
    id: 38,
    db: 'hospital',
    ...
    expectedResult: { columns: ['patient_id','admission_date','diagnosis'], rows: [] },
  },
  {
    id: 39,
    db: 'hospital',
    ...
    expectedResult: { columns: ['specialty','doctor_count'], rows: [] },
  },
  {
    id: 40,
    db: 'hospital',
  ...
  },
  {
    ...
    expectedResult: { columns: ['department_name','doctor_name','admission_count'], rows: [] },
  },
  {
    id: 42,
    db: 'hospital',
    ...
    expectedResult: { columns: ['patient_id','full_name'], rows: [] },
  },
  {
    id: 43,
    db: 'hospital',
    ...
    expectedResult: { columns: ['last_name','patient_count'], rows: [] },
  },
  {
    id: 44,
    db: 'hospital',
    ...
    expectedResult: { columns: ['doctor_name','first_admission','last_admission'], rows: [] },
  },
  {
    id: 45,
    db: 'hospital',
  ...
  // ══════════════════════════════════════════════
  {
    ...
    expectedResult: { columns: ['doctor_id','doctor_name','admission_count','doctor_rank'], rows: [] },
  },
  {
    id: 47,
    db: 'hospital',
    ...
    expectedResult: { columns: ['patient_id','admission_date','prev_admission_date'], rows: [] },
  },
  {
    id: 48,
    db: 'hospital',
    ...
    expectedResult: { columns: ['department_name','diagnosis','diagnosis_count','row_num'], rows: [] },
  },
  {
    id: 49,
    db: 'hospital',
    ...
    expectedResult: { columns: ['month','monthly_count','running_total'], rows: [] },
  },
  {
    id: 50,
    db: 'hospital',
    ...
    expectedResult: { columns: ['patient_id','first_name','last_name'], rows: [] },
  },
  {
    id: 51,
    db: 'hospital',
  ...
  },
  {
    ...
    expectedResult: { columns: ['patient_id','first_name','max_gap_days'], rows: [] },
  },
  {
    id: 53,
    db: 'hospital',
    ...
    expectedResult: { columns: ['patient_id','admission_date','diagnosis','rn'], rows: [] },
  },
  {
    id: 54,
    db: 'hospital',
    ...
    expectedResult: { columns: ['patient_id','first_name','doctor_count'], rows: [] },
  },
  {
    id: 55,
    db: 'hospital',
    ...
    expectedResult: { columns: ['month_number','month_name','admission_count'], rows: [] },
  },
  {
    id: 56,
    db: 'hospital',
    ...
    expectedResult: { columns: ['patient_id','admission_date','diagnosis','next_admission_date'], rows: [] },
  },
  {
    id: 57,
    db: 'hospital',
    ...
    expectedResult: { columns: ['month','admission_count','prev_month_count','growth_pct'], rows: [] },
  },
  {
    id: 58,
    db: 'hospital',
    ...
    expectedResult: { columns: ['doctor_name','admission_count','quartile'], rows: [] },
  },
  {
    id: 59,
    db: 'hospital',
    ...
    expectedResult: { columns: ['department_name','head_doctor_name','specialty'], rows: [] },
  },
  {
    id: 60,
    db: 'hospital',
    ...
    expectedResult: { columns: ['department_name','readmission_rate_pct'], rows: [] },
  },
];
